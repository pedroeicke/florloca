...
interface AdCardProps {
  ...
  variant?: 'auto' | 'standard';
}

const AdCard: React.FC<AdCardProps> = ({ ad, onClick, sellerContext, variant = 'auto' }) => {
  ...
  // --- ADULT CARD LAYOUT ---
  if ((ad.category === 'adultos' || ad.category === 'acompanhantes') && variant !== 'standard') {
